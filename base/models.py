...
class Product(models.Model):
        ...
        type=models.CharField(max_length=100,default="Organic",blank=True,null=True)
        stock_count=models.CharField(max_length=100,default="10",blank=True,null=True)
        life=models.CharField(max_length=100,default="100 ",blank=True,null=True)
        ...
        sku=ShortUUIDField(unique=True,max_length=34,prefix="sku",alphabet="abcdefgh12345")
...
#######################################Cart, Order, OnderlTems and Address#######################################
#######################################Cart, Order, OnderlTems and Address#######################################
#######################################Cart, Order, OnderlTems and Address#######################################
#######################################Cart, Order, OnderlTems and Address#######################################
...
class CartOrderItems(models.Model):
    ...
    qty=models.IntegerField(default="o")
    price=models.DecimalField(max_digits=99999999,decimal_places=2,default="1.99")
