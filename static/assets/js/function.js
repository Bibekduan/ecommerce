...
$(".add-to-cart-btn").on("click", function(){   
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            this_val.html("✓")
            // this_val.html("Product Is Add")//<i class='fas fa-check-circle'></i>
...
//delete cart
    ...
    $(document).on("click",".add-to-wishlist", function(){
        ...
        $.ajax({
            ...
            dataType:"json",
            beforeSend:function() {
                console.log("Try to add wishlist")
            },
            success: function(response) {
                this_val.html("✓")
    ...
    $(document).on("submit","#contact-form-ajax",function(e){
        ...
        $.ajax({
            ...
            dataType:"json",
            beforeSend:function(){
                console.log("sending data to the sorver");
...
//     // console.log("T",product_title);
//     // console.log("I",product_id);
//     // console.log("P",product_price);
//     // console.log("CART",this_val);
